...
class _MessageTextFieldState extends State<MessageTextField> {
  ...
  Future<void> _getCurrentLocation() async {
    ...
    if (permission == LocationPermission.deniedForever) {
      Fluttertoast.showToast(msg: "Location permissions are permanently denied. Enable them in settings.");
      return;
    }
    ...
    try {
      ...
      _getAddressFromLatLon(); // Convert to address after getting location
    } catch (e) {
  ...
  _getAddressFromLatLon() async {
    try {
      if (_curentPosition == null) return;
      ...
      if (placemarks.isNotEmpty) {
        ...
        Fluttertoast.showToast(msg: "Failed to retrieve address.");
      }
    } catch (e) {
          ...
          children: [
            chatsIcon(Icons.location_pin, "Location", () async {
              ...
              if (_curentPosition != null) {
                ...
                sendMessage(locationMessage, "link");
              } else {
