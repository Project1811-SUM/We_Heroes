...
class DatabaseHelper {
  ...
  //setters of the class . for example: _database getter is used when we want to initialize  the db.
...
// Insert a contact object
  ...
  // Get the 'Map List ' [ List<Map>] and convert it to 'Contact List'  [List<TContact>]
  Future<List<TContact>> getContactList() async {
    var contactMapList =
        await getContactMapList(); // get the Map List containing Contact object
    int count = contactMapList
        .length; // get total number of Contact objects in the list
