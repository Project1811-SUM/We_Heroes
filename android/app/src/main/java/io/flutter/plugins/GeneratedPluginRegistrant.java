...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.fluttercommunity.shake_gesture_android.ShakeGesturePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin shake_gesture_android, dev.fluttercommunity.shake_gesture_android.ShakeGesturePlugin", e);
    }
    try {
